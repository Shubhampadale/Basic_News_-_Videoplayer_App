...
public class videoview1 extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url="https://www.googleapis.com/youtube/v3/videos?id=5uTQz43k4gg&key=AIzaSyDM7CwAcEtwea4SSLvwu-OiMU3QFR66aZ8&part=snippet,contentDetails,statistics,status";
        ...
        mOnInitializedListener = new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                ...
                youTubePlayer.loadVideo("5uTQz43k4gg");
            }
