...
public class videoview extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url="https://www.googleapis.com/youtube/v3/videos?id=9lF4d4w84uM&key=AIzaSyDM7CwAcEtwea4SSLvwu-OiMU3QFR66aZ8&part=snippet,contentDetails,statistics,status";
        ...
        mOnInitializedListener = new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                ...
                youTubePlayer.loadVideo("9lF4d4w84uM");
            }
