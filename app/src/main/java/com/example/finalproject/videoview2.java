...
public class videoview2 extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url="https://www.googleapis.com/youtube/v3/videos?id=R3fRIgNOdio&key=AIzaSyDM7CwAcEtwea4SSLvwu-OiMU3QFR66aZ8&part=snippet,contentDetails,statistics,status";
        ...
        mOnInitializedListener = new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                ...
                youTubePlayer.loadVideo("R3fRIgNOdio");
            }
